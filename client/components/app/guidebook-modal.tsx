  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Bạn chỉ có thể chiếm ô Long Mạch có hình con giáp của chính mình bằng cách di chuyển đứng vào ô đó.'
      ]
    },
    {
    ...
    },
    {
      ...
      bullets: [
        ...
        'Pha 2 - Dùng bài trước khi di: bạn có tối đa 60 giây để kích hoạt các lá bài phép trên tay. Mỗi lần dùng 1 lá được cộng thêm 10 giây nhưng tổng thời gian không quá 60 giây.',
        'Pha 3 - Di chuyển: dùng các nút mũi tên để di đúng số bước mà xúc xắc vừa đổ ra.',
        'Pha 4 - Dùng bài sau khi di: tương tự pha 2, bạn có thêm một cơ hội dùng bài trước khi kết thúc lượt.'
      ]
    },
    {
