export const CHARACTERS_DATA = [
  {
    ...
    timing: "+",
    skill_description:
      "Khi 1 người lấy lương thực tại Shop có từ 2 bao trở lên, bạn lấy tất cả số bao còn lại.",
    effect: { 
        action: "steal_food", 
        target: "any_shop", 
        value: 0 
  ...
  },
  {
    ...
    timing: "-",
    skill_description:
      "Húc văng 1 lá bài trên tay người khác và đẩy người đó đi 2 ô.",
    effect: { 
        action: "force_move", 
        target: "other", 
        value: 2 
  ...
  },
  {
    ...
    timing: "+",
    skill_description:
      "Khi 1 người khác lấy 1 bao lương thực từ Shop, ép người đó cống nạp cho bạn.",
    effect: { 
        action: "steal_food", 
        target: "other", 
        value: 1 
  ...
  },
  {
    ...
    timing: "+",
    skill_description:
      "Ru ngủ 1 người, khiến họ không thể di chuyển (có thể dùng lên bản thân).",
    effect: { 
  ...
  },
  {
    ...
    timing: "+",
    skill_description:
      "Đổ lại xúc xắc và đi giúp người khác theo hướng bạn muốn.",
    effect: { 
        action: "force_dice", 
        target: "any", 
        value: 0 
  ...
  },
  {
    ...
    timing: "+",
    skill_description:
      "Yêu cầu 1 người chọn mặt đối lập của xúc xắc ngay sau khi họ vừa đổ.",
    effect: { 
        action: "force_dice", 
        target: "other", 
        value: -1 
  ...
  },
  {
    ...
    timing: "-",
    skill_description:
      "Tặng 1 lá bài của mình cho người khác, ép họ phải đưa lại 2 lá bài.",
    effect: { 
        action: "steal_card", 
        target: "other", 
        value: 2 
